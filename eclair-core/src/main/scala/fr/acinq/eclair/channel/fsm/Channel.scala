  ...
  when(NORMAL)(handleExceptions {
        ...
        case SpliceStatus.NoSplice =>
          if (d.metaCommitments.isIdle && d.metaCommitments.params.channelFeatures.hasFeature(DualFunding)) {
            ...
            val fundingParams = InteractiveTxParams(
              ...
              commonInput_opt = Some(parentCommitments.commitment.commitInput),
            ...
            val txBuilder = context.spawnAnonymous(InteractiveTxBuilder(
              ...
              purpose = InteractiveTxBuilder.SpliceTx(parentCommitments.common, parentCommitments.commitment),
      ...
      d.spliceStatus match {
        case SpliceStatus.SpliceRequested(cmd, init) =>
          ...
          val fundingParams = InteractiveTxParams(
            channelId = d.channelId,
            isInitiator = true,
            localAmount = cmd.additionalLocalFunding,
            remoteAmount = msg.fundingContribution,
            commonInput_opt = Some(parentCommitments.commitment.commitInput),
    ...
    case Event(msg: InteractiveTxBuilder.Response, d: DATA_NORMAL) => msg match {
      ...
      case InteractiveTxBuilder.Succeeded(fundingParams, fundingTx, commitment) =>
        log.info(s"splice completed: new funding txid=${fundingTx.txId} tx=${fundingTx.signedTx_opt.getOrElse("n/a")}")
        ...
        val metaCommitments1 = d.metaCommitments.copy(commitments = commitment +: d.metaCommitments.commitments)
        val d1 = d.copy(metaCommitments = metaCommitments1, spliceStatus = SpliceStatus.NoSplice)
        fundingTx match {
